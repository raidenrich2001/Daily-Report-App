...
export default function Departments() {
    ...
    useEffect(() => {
        axios.get(`http://172.16.0.160:3001/getdepartmentusers/${department}`).then(res => setUsers(res.data.user))
    }, [department])
    // console.log(user)

    useEffect(() => {
        axios.get(`http://172.16.0.160:3001/getdepartmentreport/${department}`).then(res => setProgres(res.data.user))
    }, [department])
