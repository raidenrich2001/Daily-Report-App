...
export default function Login() {
    ...
    function handleLogin(e)
    {
     ...
     axios.post('http://172.16.0.160:3001/login',data).then(res => res.data.message === "Successfully Login"? navigate(`/task/${res.data.user._id}/${res.data.user.department}`): alert('Wrong Credential'))
