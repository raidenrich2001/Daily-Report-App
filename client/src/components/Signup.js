...
export default function Signup() {
    ...
    function handleSignup(e)
    {
     ...
     axios.post('http://172.16.0.142:3001/signup',data).then(res => res.data.message === "Added Successfully"? alert("Added Successfully"): alert(res.data.message)).then(navigate('/'))
    }
