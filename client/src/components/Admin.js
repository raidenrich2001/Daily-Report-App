...
export default function Admin() {
  ...
  useEffect(() => {
    axios.get(`http://172.16.0.160:3001/singleuserusingid/${id}`).then((res) => { setAdminuser(res.data) })
  }, [])

  useEffect(() => {
    axios.get(`http://172.16.0.160:3001/getdepartmentreport/${id}/${department}`).then(res => setProgres(res.data))
  }, [])


  useEffect(() => {
    axios.get(`http://172.16.0.160:3001/getdepartmentuser/${id}/${department}`).then(res => setUser(res.data))
  }, [])
